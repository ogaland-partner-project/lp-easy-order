...
class CreateRawMaterialsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('t_raw_materials', function (Blueprint $table) {
            $table->bigIncrements('id');
            $table->unsignedBigInteger('item_karte_id')->comment('商品カルテID');
            $table->string('raw_material_name')->comment('使用原料・成分など')->nullable();
            // システムカラム
            ...
            // 外部キー設定
            $table->foreign('item_karte_id')->references('id')->on('t_item_kartes');
        });
    }
    ...
    {
        Schema::dropIfExists('t_raw_materials');
    }
}
