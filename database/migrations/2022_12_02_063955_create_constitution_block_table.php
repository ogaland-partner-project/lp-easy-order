...
class CreateConstitutionBlockTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('t_constitution_blocks', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('t_constitution_blocks');
    }
}
