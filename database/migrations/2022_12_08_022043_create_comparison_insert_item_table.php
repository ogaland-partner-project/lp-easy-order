...
class CreateComparisonInsertItemTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('t_comparison_insert_items', function (Blueprint $table) {
            $table->bigIncrements('id');
            $table->unsignedBigInteger('comparison_header_id')->comment('比較構成ヘッダーID');
            ...
            // 外部キー設定
            $table->foreign('comparison_header_id')->references('id')->on('t_comparison_insert_headers');
        });
    }
    ...
    {
        Schema::dropIfExists('t_comparison_insert_items');
    }
}
