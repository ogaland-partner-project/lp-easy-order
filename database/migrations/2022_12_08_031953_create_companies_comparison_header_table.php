...
class CreateCompaniesComparisonHeaderTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('t_companies_comparison_headers', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('t_companies_comparison_headers');
    }
}
