...
class CreatePlanThumbnailImagesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('t_plan_thumbnail_images', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('t_plan_thumbnail_images');
    }
}
