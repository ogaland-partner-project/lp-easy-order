<template>
    <div class="plan_main">
        <div class="plan_header mb-3">
            ...
            <div class="mt-5" style="width:100%; display:flex;">
                ...
                <div style="width:45%; display:flex;">
                    <div v-if="planTab == 1" class="d-flex">
                        <div>
            ...
            <div class="titlearia mb-2 d-flex" v-if="planTab==1">
                <div style="width:55%; display:flex; padding-left:50px">
                    <div class="itembox" style="width:40%;">イメージ</div>
                    <div class="itembox" style="width:60%">文言</div>
                </div>
                <div style="width:45%; display:flex;">
        ...
        <v-tabs-items v-model="planTab">
            <v-tab-item>
                <div class="titlearia mb-2">
                    <div class="itembox ml-5">構成の手順から自動入力</div>
                </div>
            ...
            <v-tab-item>
                <div style="display:flex; width:100%;">
                    <div style="display:flex; flex-flow:column;" class="w-100">
                        <!-- thumbnail -->
                        <draggable
                        ...
                        >
                            <v-hover v-slot="{ hover }" class="plan_hover_bar" v-for="(thumbnail,n) in planThumbnails" :key="thumbnail.sort_order">
                                <div :class="hover ? 'plan_active':'none'">
                                    <!-- サムネ画像系 -->
                                    <div style="width:55% !important; display:flex;">
                                                            ...
                                                            <div class="wording-area">
                                                                <div class="wording-select">
                                                                    ...
                                                                    <v-combobox
                                                                        ...
                                                                        hide-details="auto"
                                                                        class="plan_combo"
                                                                        :class="'thumbnail_combo_attach'+n+'_'+index"
                                                                        density="compact"
                                                                        :attach="'.thumbnail_combo_attach'+n+'_'+index"
                                                                        :disabled="isCheckMedicineStatus()"
                                                                    >
