...
class ComparisonInsertApi extends ApiController
{
    ...
    public function create(ComparisonInsertCreateRequest $request,CreateService $service)
    {
        ...
        $headers = [
            ...
            ["header_name"=>"レビュー数", "header_type"=>"text","comparison_insert_flag"=>1,"companies_comparison_flag"=>0],
            ["header_name"=>"レビュー評価", "header_type"=>"text","comparison_insert_flag"=>1,"companies_comparison_flag"=>0],
