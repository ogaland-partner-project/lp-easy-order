...
class CompaniesComparisonUpdateRequest extends BaseRequest
{
        ...
        return [
            ...
            "items" => [ "description" => "テーブルの要素", "example" => [
                    [
                        ...
                        ["id"=>2,"text"=>"","color"=>"white","editable"=>false],
                        ["id"=>3,"text"=>"/storage/~~~","file"=>"XXX.jpg","color"=>"white","editable"=>false],
                        ["id"=>null,"text"=>"2090","editable"=>false],
                    ],
                    [
                        ["id"=>4,"text"=>"キュットスリムと下着通販GB-style","color"=>"white","editable"=>false],
                        ["id"=>5,"text"=>"","color"=>"white","editable"=>false],
                        ["id"=>6,"text"=>"/storage/~~~","file"=>"XXX.jpg","color"=>"white","editable"=>false],
